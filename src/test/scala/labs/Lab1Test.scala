...
class ALUControlUnitRTypeTester(c: ALUControl) extends PeekPokeTester(c) {
  ...
  val tests = List(
    //    aluop,   arth_type,       int_length,       Funct7,    Func3,   Control,  Input
    (       1.U,         0.U,           0.U,  "b0000000".U, "b000".U, "b00000".U, "add"),
    (       1.U,         0.U,           0.U,  "b0100000".U, "b000".U, "b00001".U, "sub"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b001".U, "b01010".U, "sll"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b010".U, "b01100".U, "slt"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b011".U, "b01111".U, "sltu"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b100".U, "b01000".U, "xor"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b101".U, "b01011".U, "srl"),
    (       1.U,         0.U,           0.U,  "b0100000".U, "b101".U, "b01001".U, "sra"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b110".U, "b00111".U, "or"),
    (       1.U,         0.U,           0.U,  "b0000000".U, "b111".U, "b00101".U, "and"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b000".U, "b00010".U, "mul"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b001".U, "b10101".U, "mulh"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b010".U, "b11000".U, "mulhsu"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b011".U, "b10111".U, "mulhu"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b100".U, "b00011".U, "div"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b101".U, "b01101".U, "divu"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b110".U, "b00100".U, "rem"),
    (       1.U,         0.U,           0.U,  "b0000001".U, "b111".U, "b01110".U, "remu"),
    (       1.U,         0.U,           1.U,  "b0000000".U, "b000".U, "b10000".U, "addw"),
    (       1.U,         0.U,           1.U,  "b0100000".U, "b000".U, "b10001".U, "subw"),
    (       1.U,         0.U,           1.U,  "b0000000".U, "b001".U, "b11010".U, "sllw"),
    (       1.U,         0.U,           1.U,  "b0000000".U, "b101".U, "b11011".U, "srlw"),
    (       1.U,         0.U,           1.U,  "b0100000".U, "b101".U, "b11001".U, "sraw"),
    (       1.U,         0.U,           1.U,  "b0000001".U, "b000".U, "b10010".U, "mulw"),
    (       1.U,         0.U,           1.U,  "b0000001".U, "b100".U, "b10011".U, "divw"),
    (       1.U,         0.U,           1.U,  "b0000001".U, "b101".U, "b11101".U, "divuw"),
    (       1.U,         0.U,           1.U,  "b0000001".U, "b110".U, "b10100".U, "remw"),
    (       1.U,         0.U,           1.U,  "b0000001".U, "b111".U, "b11110".U, "remuw"),
  )

  for (t <- tests) {
    poke(ctl.io.aluop, t._1)
    poke(ctl.io.arth_type, t._2)
    poke(ctl.io.int_length, t._3)
    poke(ctl.io.funct7, t._4)
