...
object simulate_predefined_system {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val (cpuType, memType, memPortType, memoryLatency)  = systemName match {
      ...
      case "system4" => ("pipelined-non-combin", "non-combinational", "non-combinational-port", 30)
      case "system5" => ("single-cycle-non-combin", "non-combinational", "non-combinational-port", 30)
      case "system6" => ("single-cycle-non-combin", "non-combinational", "non-combinational-port", 30)
      case "system7" => ("single-cycle-non-combin", "non-combinational", "non-combinational-port", 30)
      case "system8" => ("single-cycle-non-combin", "non-combinational", "non-combinational-port", 30)
    }
