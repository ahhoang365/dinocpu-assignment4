...
class Top(val conf: CPUConfig) extends Module
{
  ...
  val l1_cache = if (system_name == "default" || system_name == "default-single-cycle" || system_name == "single-cycle" || system_name == "pipelined") conf.getEmptyCache() else Module(conf.getL1Cache(1))
  ...
  system_name match {
    ...
    case "system5" => build_system_1()
    case "system6" => build_system_2()
    case "system7" => build_system_3()
    case "system8" => build_system_4()
    case _ => throw new IllegalArgumentException(
      "Unknown system name. Choices: default, single-cycle, pipelined, system1, system2, system3, system4, system5, system6, system7, system8."
    )
  }
