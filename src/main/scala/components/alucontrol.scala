    ...
    when (io.int_length === 0.U) { // 64-bit
      io.operation := MuxCase(
        ...
        Array(
          ...
          ((io.funct3 === "b001".U) & (io.funct7(6,1) === "b000000".U)) -> "b01010".U, // slli
          (io.funct3 === "b010".U) -> "b01100".U, // slti
          (io.funct3 === "b011".U) -> "b01111".U, // sltiu
          (io.funct3 === "b100".U) -> "b01000".U, // xori
          ((io.funct3 === "b101".U) & (io.funct7(6,1) === "b000000".U)) -> "b01011".U, // srli
          ((io.funct3 === "b101".U) & (io.funct7(6,1) === "b010000".U)) -> "b01001".U, // srai
    ...
    .otherwise { // 32-bit
      io.operation := MuxCase(
        ...
        Array(
          ...
          ((io.funct3 === "b001".U) & (io.funct7(6,1) === "b000000".U)) -> "b11010".U, // slliw
          ((io.funct3 === "b101".U & io.funct7(6,1) === "b000000".U)) -> "b11011".U, // srliw
          ((io.funct3 === "b101".U & io.funct7(6,1) === "b010000".U)) -> "b11001".U, // sraiw
        )
      )
    }
    }
  }
  .elsewhen (io.aluop === 2.U) { // non-arithmetic instruction types that uses ALU (auipc/jal/jarl/Load/Store)
